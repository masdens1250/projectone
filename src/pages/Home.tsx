    ...
    <div>
      ...
      <section className="relative bg-secondary text-neutral py-20">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2">
            <img 
              src="https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1374&q=80" 
      ...
      <section className="py-16 bg-secondary text-neutral">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-neutral text-secondary p-6 rounded-lg shadow-md">
              <div className="flex items-center mb-4">
                <img src="https://sparwan.com/cdn/shop/articles/RustDesk.webp?v=1718634087&width=487" alt="RustDesk Logo" className="h-10 w-10 mr-3" />
      ...
      <section className="py-16 bg-neutral">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4 text-secondary">Prêt à améliorer l'infrastructure informatique de votre établissement ?</h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="bg-secondary text-neutral hover:bg-secondary-light font-bold py-3 px-6 rounded-md transition-colors inline-flex items-center justify-center shadow-custom"
            >
