      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow transform hover:-translate-y-1 duration-300 border border-gray-100">
              ...
              <div className="mb-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    <CheckCircle className="text-green-600 mr-2 mt-1 flex-shrink-0" size={18} />
                    <span className="text-gray-600">Tarif fixe : 35 700 DA/an</span>
                  </li>
                </ul>
              </div>
              <Link to="/contact" className="inline-block bg-green-700 hover:bg-green-800 text-white font-bold py-2 px-4 rounded transition-colors shadow-md">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow transform hover:-translate-y-1 duration-300 border border-gray-100">
              <Wifi className="text-green-600 mb-4" size={48} />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow transform hover:-translate-y-1 duration-300">
              <Headset className="text-green-600 mb-4" size={40} />
              ...
              <Link to="/remote-support" className="text-green-700 font-medium hover:text-green-800 inline-flex items-center">
                En savoir plus
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow transform hover:-translate-y-1 duration-300">
              ...
              <Link to="/contact" className="text-green-700 font-medium hover:text-green-800 inline-flex items-center">
                Nous contacter
                <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path>
                </svg>
            ...
            <div className="space-y-12">
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-12 flex justify-center my-4 md:my-0">
                  <div className="w-12 h-12 rounded-full bg-green-700 text-white flex items-center justify-center font-bold text-xl z-10">1</div>
                </div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-12 flex justify-center my-4 md:my-0">
                  <div className="w-12 h-12 rounded-full bg-green-700 text-white flex items-center justify-center font-bold text-xl z-10">2</div>
                </div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-12 flex justify-center my-4 md:my-0">
                  <div className="w-12 h-12 rounded-full bg-green-700 text-white flex items-center justify-center font-bold text-xl z-10">3</div>
                </div>
                <div className="md:w-1/2 md:pl-12 md:text-left"></div>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 md:pr-12 md:text-right"></div>
                <div className="md:w-12 flex justify-center my-4 md:my-0">
                  <div className="w-12 h-12 rounded-full bg-green-700 text-white flex items-center justify-center font-bold text-xl z-10">4</div>
                </div>
                <div className="md:w-1/2 md:pl-12 md:text-left">
      ...
      <section className="py-16 bg-green-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Link to="/contact" className="bg-white hover:bg-gray-100 text-green-700 font-bold py-3 px-6 rounded-md transition-colors inline-flex items-center justify-center shadow-md">
              Nous contacter
            </Link>
            <Link to="/pricing" className="bg-transparent hover:bg-green-600 border-2 border-white text-white py-3 px-6 rounded-md transition-colors inline-flex items-center justify-center">
              Voir nos tarifs
            </Link>
          </div>
        </div>
