            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden mb-12">
              <div className="bg-green-700 text-white p-6 text-center">
                ...
                <div className="mt-4 flex items-center justify-center">
                  <span className="text-4xl font-bold">35 700 DA</span>
                  <span className="ml-2 text-green-200">/an</span>
                </div>
              </div>
              <div className="p-6">
                ...
                <div className="mt-8 text-center">
                  <Link to="/contact" className="inline-block bg-green-700 hover:bg-green-800 text-white font-bold py-3 px-6 rounded-md transition-colors">
            ...
            <table className="w-full bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <tbody>
                <tr className="border-b border-gray-200">
                  ...
                  <td className="py-4 px-6 text-center"><CheckCircle className="text-green-600 mx-auto" size={20} /></td>
                ...
                <tr className="border-b border-gray-200">
                  ...
                  <td className="py-4 px-6 text-center"><span className="font-medium text-green-700">24-48h</span></td>
                  <td className="py-4 px-6 text-center"><span className="font-medium text-green-700">Planifié</span></td>
                </tr>
                <tr className="border-b border-gray-200">
                ...
                <tr>
                  ...
                  <td className="py-4 px-6 text-center"><span className="font-medium">35 700 DA/an</span></td>
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-3 flex items-center">
                <HelpCircle className="text-green-600 mr-2" size={20} />
      ...
      <section className="py-16 bg-green-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Link to="/contact" className="bg-white text-green-700 hover:bg-gray-100 font-bold py-3 px-6 rounded-md transition-colors inline-flex items-center justify-center">
              Nous contacter
            </Link>
            <a 
              ...
              className="bg-transparent hover:bg-green-600 border-2 border-white py-3 px-6 rounded-md transition-colors inline-flex items-center justify-center"
            >
