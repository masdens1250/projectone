          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="md:w-1/2">
              ...
              <p className="text-gray-600 mb-6">
                Fondée en 2023, NetScolaire-DZ a pour mission de fournir des services informatiques de qualité aux établissements scolaires de la wilaya de Mostaganem et ses environs. Nous comprenons l'importance d'une infrastructure informatique fiable dans le milieu éducatif et nous nous engageons à offrir des solutions adaptées aux besoins spécifiques des écoles.
              </p>
              <p className="text-gray-600 mb-6">
