                  ...
                  {activeTab === 'teamviewer' ? (
                    <div className="flex items-center">
                      <div className="flex items-center mr-4">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/9/90/TeamViewer_logo.svg" alt="TeamViewer Logo" className="h-10 mr-2" />
                        <div>
                          <h3 className="font-bold text-[#0e6bcd]">Team<span className="text-black">Viewer</span></h3>
                        </div>
                      </div>
                      <div className="flex-grow">
                        <p className="text-sm text-gray-600">Logiciel de télémaintenance sécurisé permettant à nos techniciens d'accéder à votre ordinateur à distance pour résoudre vos problèmes.</p>
                      </div>
                      <a 
                    ...
                    <div className="flex items-center">
                      <div className="flex items-center mr-4">
                        <img src="https://rustdesk.com/images/logo-rustdesk.svg" alt="RustDesk Logo" className="h-10 mr-2" />
                        <div>
                          <h3 className="font-bold text-[#0e6bcd]">Rust<span className="text-black">Desk</span></h3>
                        </div>
                      </div>
                      <div className="flex-grow">
                        <p className="text-sm text-gray-600">Alternative open-source pour l'assistance à distance, offrant une connexion sécurisée pour le support technique.</p>
                      </div>
                      <a 
