            ...
            <div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  ...
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path d="M12 2c2.717 0 3.056.01 4.122.06 1.065.05 1.79.217 2.428.465.66.254 1.216.598  1.772.59 1.772 1.153 2.771 2.408 2.771 1.55 0 2.8-1.6 2.8-3.57C18.2 2.83 15.38 0 12 0S5.8 2.83 5.8 6.3c0 1.97 1.25 3.57 2.8 3.57.577 0 1.112-.23 1.53-.65.092-.09.226-.07.307.04.09.12.07.28-.05.36-.12.09-.27.07-.36-.05-.52.52-1.23.8-1.97.8-1.97 0-3.57-1.8-3.57-4.02C4.5 3.8 7.97.5 12 .5s7.5 3.3 7.5 7.3c0 2.22-1.6 4.02-3.57 4.02-.74 0-1.45-.28-1.97-.8-.09-.12-.24-.14-.36-.05-.12.08-.14.24-.05.36.42.42.95.65 1.53.65 1.55 0 2.8-1.6 2.8-3.57C16.2 2.83 13.38 0 10 0S3.8 2.83 3.8 6.3c0 1.97 1.25 3.57 2.8 3.57.577 0 1.112-.23 1.53-.65.092-.09.226-.07.307.04.09.12.07.28-.05.36-.12.09-.27.07-.36-.05-.52.52-1.23.8-1.97.8-1.97 0-3.57-1.8-3.57-4.02C2.5 3.8 5.97.5 10 .5s7.5 3.3 7.5 7.3c0 2.22-1.6 4.02-3.57 4.02-.74 0-1.45-.28-1.97-.8-.09-.12-.24-.14-.36-.05-.12.08-.14.24-.05.36.42.42.95.65 1.53.65 1.55 0 2.8-1.6 2.8-3.57C14.2 2.83 11.38 0 8 0S1.8 2.83 1.8 6.3c0 1.97 1.25 3.57 2.8 3.57.577 0 1.112-.23 1.53-.65.092-.09.226-.07.307.04.09.12.07.28-.05.36-.12.09-.27.07-.36-.05-.52.52-1.23.8-1.97.8-1.97 0-3.57-1.8-3.57-4.02C.5 3.8 3.97.5 8 .5s7.5 3.3 7.5 7.3c0 2.22-1.6 4.02-3.57 4.02-.74 0-1.45-.28-1.97-.8-.09-.12-.24-.14-.36-.05-.12.08-.14.24-.05.36.42.42.95.65 1.53.65 1.55 0 2.8-1.6 2.8-3.57"/>
                    </svg>
                  </a>
                  <a 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
                      placeholder="exemple: lyce.zerrouki@gmail.com"
                    />
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto mb-8">
            Contactez-nous directement par téléphone ou WhatsApp pour une réponse rapide à vos questions.
          </p>
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <a 
              href="tel:+213783328729" 
              className="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-md transition-colors inline-flex items-center justify-center"
            >
